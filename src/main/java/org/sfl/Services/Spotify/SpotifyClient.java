...
import org.sfl.SpotifyDTOs.SpotifyWrappersDTOs.SpotifyTrackWrapper;
import org.sfl.SpotifyDTOs.SubDTOs.SpotifyAlbum;
import org.sfl.SpotifyDTOs.SubDTOs.SpotifyImage;
...
public class SpotifyClient {
    ...
    public SpotifySearchResponse search(String query) {
        try {
            ...
            List<SpotifyArtist> artists = jsonMapper.readerForListOf(SpotifyArtist.class)
                    .readValue(json.get("artists").get("items"));
    ...
    public SpotifyArtist getArtist(String artistId) {
        try {
            ...
            throw new SpotifyClientException("Failed to fetch artist: " + e.getMessage(), e);
        }
    }
